...
print "Done Arranging Files and Folder in your specified directory"# Script Name	: check_for_sqlite_files.py
# Author		: Craig Richards
...
while True:
  ...
  if row == None:
    break
  print row[0]print(x for x in range(2,100,2))import pygame, sys, time
...
if os.path.exists(CheckDir):#Checks if the dir exists
	...
	print("Directory created for "+CheckDir)import sys
